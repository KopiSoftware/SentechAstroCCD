...
namespace SensorTechnology {
	public class StTrg {
		...
		public static extern bool GetAveragePixelValue(uint dwImageWidth, uint dwImageHeight, ushort wColorArray, uint dwTransferBitsPerPixel, System.IntPtr pbyteRaw, uint dwAOIOffsetX, uint dwAOIOffsetY, uint dwAOIWidth, uint dwAOIHeight, System.IntPtr pfAverage);
		...
		public static extern bool NoiseReduction2(System.IntPtr hCamera, uint dwNoiseReductionMode, uint dwWidth, uint dwHeight, ushort wColorArray, System.IntPtr pbyteRaw, ushort wRawBitsPerPixel);
		#endregion
		...
		public static extern bool RawColorGamma2(System.IntPtr hCamera, uint dwWidth, uint dwHeight, ushort wColorArray, System.IntPtr pbyteRaw, ushort wRawBitsPerPixel);
		[DllImport("StTrgAPI.dll", EntryPoint="StTrg_BGRGamma2")]
		public static extern bool BGRGamma2(System.IntPtr hCamera, uint dwWidth, uint dwHeight, uint dwPixelFormat, System.IntPtr pbyteBGR, ushort wBitsPerEachColor);
		...
		public static extern bool Sharpness2(System.IntPtr hCamera, uint dwWidth, uint dwHeight, uint dwPixelFormat, System.IntPtr pbyteGrayOrBGR, ushort wBitsPerEachColor);
