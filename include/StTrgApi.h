...
BOOL WINAPI StTrg_NoiseReduction2(HANDLE hCamera, DWORD dwNoiseReductionMode, DWORD dwWidth, DWORD dwHeight, WORD wColorArray, PBYTE pbyteRaw, WORD wRawBitsPerPixel);
...
BOOL WINAPI StTrg_RawColorGamma2(HANDLE hCamera, DWORD dwWidth, DWORD dwHeight, WORD wColorArray, PBYTE pbyteRaw, WORD wRawBitsPerPixel);
BOOL WINAPI StTrg_BGRGamma2(HANDLE hCamera, DWORD dwWidth, DWORD dwHeight, DWORD dwPixelFormat, PBYTE pbyteBGR, WORD wBitsPerEachColor);
...
BOOL WINAPI StTrg_Sharpness2(HANDLE hCamera, DWORD dwWidth, DWORD dwHeight, DWORD dwPixelFormat, PBYTE pbyteGrayOrBGR, WORD wBitsPerEachColor);
